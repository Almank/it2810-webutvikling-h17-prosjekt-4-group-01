...
export { MatDialog, MatTabsModule } from '@angular/material';
...
export { MovieListComponent } from './movie-view/movie-list/movie-list.component';
export { MovieListService } from './movie-view/movie-view.service';
export { MovieDetailsComponent } from './movie-view/movie-details/movie-details.component';
...
export { MatSelectModule, MatButtonModule, MatGridListModule, MatDialogModule, MatCardModule,
  MatIconModule, MatInputModule, MatPaginatorModule, MatSidenavModule, MatTableModule,
  MatToolbarModule, MatTooltipModule, MatFormFieldModule } from '@angular/material';
...
export {MovieDetailsService} from './movie-view/movie-details/movie-details.service';
...
export {MatSnackBarModule} from '@angular/material';
export {RouterTestingModule} from '@angular/router/testing';
export {MAT_DIALOG_DATA, MatDialogRef} from '@angular/material';
export {CommonModule} from '@angular/common';
export {Favorite} from './profile/profile.favorite.service';
export {Inject} from '@angular/core';
export {MatOptionModule} from '@angular/material';
export {ViewEncapsulation} from '@angular/core';
export {MatToolbar, MatToolbarRow} from '@angular/material';
export {AuthenticationService} from './auth/auth.service';
export { AuthComponent } from './auth/auth.component';
export { MatCard, MatInkBar, MatRipple, MatTab,
