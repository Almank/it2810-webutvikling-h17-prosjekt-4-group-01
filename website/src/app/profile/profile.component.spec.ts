...
describe('ProfileComponent', () => {
  ...
  it('should display favorite movie title', () => {
    debugElement = fixture.debugElement.query(By.css('#gridTitleFav'));
    htmlElement = debugElement.nativeElement;
    expect(htmlElement.textContent).toEqual('Inception');
  });
  it('should display search history movie title', () => {
    debugElement = fixture.debugElement.query(By.css('#gridTitleSearch'));
    htmlElement = debugElement.nativeElement;
